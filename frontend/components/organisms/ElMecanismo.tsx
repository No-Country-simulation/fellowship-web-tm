  ...
  return (
    <section className="w-full bg-[#000115] py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div
          ref={stepperRef}
          className="relative mt-14 flex flex-col gap-8 md:flex-row md:justify-between md:gap-0"
        >
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-3.5">
          {dataPoints.map((d) => (
            <div
              key={d.num}
              className="border border-white/10 rounded-2xl p-4.5 bg-[#0c0d21]/60 text-center"
            >
