        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {propCards.map((card, i) => (
            <Reveal key={card.num} delay={i * 80}>
              <div
                className="group relative h-full bg-[#0c0d21]/40 hover:bg-[#15162e] border border-white/15 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-white/30 overflow-hidden"
                style={
                  card.emergence
