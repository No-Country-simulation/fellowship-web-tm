        ...
        <div className="mt-11 grid grid-cols-1 md:grid-cols-3 gap-4">
          {paths.map((p, i) => (
            <Reveal key={p.tag} delay={i * 80}>
              <Link
                href={p.href}
                className="group h-full border border-white/10 hover:border-[#FF0094]/40 hover:bg-[#FF0094]/5 hover:-translate-y-1 rounded-2xl p-7 flex flex-col justify-between transition-all duration-300"
              >
                <div>
